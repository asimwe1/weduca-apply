    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        ...
        <div className="hidden items-center space-x-4 md:flex">
          <a
            href="#"
            className="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:border-blue-600 hover:text-blue-600"
          >
            Login
          </a>
          <a
          ...
          <nav className="px-4 py-6">
            <div className="flex flex-col space-y-4">
              ...
              <div className="pt-4">
                <a
                  href="#"
                  className="mb-3 block w-full rounded-md border border-gray-300 px-4 py-2 text-center text-sm font-medium text-gray-700 transition-colors hover:border-blue-600 hover:text-blue-600"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Login
                </a>
