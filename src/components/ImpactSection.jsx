...
const ImpactSection = () => {
  ...
  return (
    <div 
      className="relative py-16 px-4 md:px-8 lg:px-16 bg-blue-600"
      style={{
        backgroundImage: "url('https://res.cloudinary.com/dhrhfjgqa/image/upload/v1741412998/Group-4153_zavcfh.png')",
    ...
    >
      ...
      <div className="container mx-auto">
        ...
        <div className="absolute bottom-4 right-4 md:bottom-8 md:right-8">
          {/* <button className="bg-blue-800 hover:bg-blue-900 text-white font-semibold py-2 px-4 rounded-md transition-colors">
            Version Française
          </button> */}
        </div>
      </div>
