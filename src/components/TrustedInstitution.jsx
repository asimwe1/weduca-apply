    ...
    return (
      <section className="py-20 px-6 bg-white">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-[#1f3254]">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mb-16">
            {countries.map((country, index) => (
              <div 
                key={index} 
                className={`flex items-center gap-2 px-4 py-2 rounded-full ${index === 0 ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800'}`}
              >
                <img 
                  src={country.flag} 
